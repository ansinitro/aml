...
%\usepackage{stmaryrd}					%New AMS symbols (COMMENTED - may not be installed)
\usepackage{amssymb}					%Calls AMS symbols
\usepackage{amsthm}					%Calls AMS theorem environment
%\usepackage{newlfont}					%Helpful package for fonts and symbols (COMMENTED - deprecated)
%\usepackage{layouts}					%Layout diagrams (COMMENTED - not needed)
